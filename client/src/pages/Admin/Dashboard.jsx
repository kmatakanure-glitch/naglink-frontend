  ...
  return expenses.filter((expense) =>
    matchesSearch(
      [
        ...
        expense.wasEditedByCEO ? "edited by ceo" : "not edited",
        expense.ceoEditNote,
...
const getFilteredDrivers = () => {
  ...
  const handleAddDriver = async (e) => {
    ...
    try {
      ...
      formData.append("idNumber", driverData.idNumber);
  ...
  const handleEditDriver = async (e) => {
    ...
    try {
      ...
      formData.append("idNumber", editingDriver.idNumber || "");
      formData.append("passportNumber", editingDriver.passportNumber || "");
      formData.append("licenseNumber", editingDriver.licenseNumber || "");
...
<th className="px-4 py-4">STATUS</th>
<th className="px-4 py-4">CEO NOTE</th>
...
<td className="min-w-[220px] px-4 py-4 text-sky-100">
  {expense.ceoEditNote ? (
    <p className="rounded-md border border-white/10 bg-white/10 p-2 text-xs">
      {expense.ceoEditNote}
    </p>
  ) : (
    <span className="text-xs text-sky-200">No CEO note</span>
  )}
</td>
          ...
          return (
            ...
            >
              ...
              <div className="p-5">
                ...
                <div className="mb-4 rounded-md border border-white/10 bg-white/10 p-4">
                  <p className="text-xs font-medium uppercase tracking-widest text-sky-200">
                    Driver Documents
                  </p>
                  ...
                  <div className="mt-3 space-y-1 text-sm text-sky-100">
                    <p>
                      <span className="font-bold text-white">ID Number:</span>{" "}
                      {driver.idNumber || "N/A"}
                    </p>

                    <p>
                      <span className="font-bold text-white">Passport:</span>{" "}
                      {driver.passportNumber || "N/A"}
                    </p>
                ...
                <form onSubmit={handleAddDriver} className="space-y-5">
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        value={driverData.passportNumber}
                        onChange={(e) =>
                          setDriverData({
                            ...driverData,
                ...
                <form onSubmit={handleEditDriver} className="space-y-5">
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        value={editingDriver.passportNumber || ""}
                        onChange={(e) =>
                          setEditingDriver({
                            ...editingDriver,
                            passportNumber: e.target.value,

...
function Fleet() {
  const fleetGallery = [
    ...
    },
    {
     ...
     {
      image: excavators,
      title: "Construction & Mining excavators",
    },
  ];
  ...
  const services = [
    ...
    },
    {
       ...
       text: "Reliable and heavy-duty excavator solutions for mining, construction, earthmoving, and large-scale infrastructure projects.",
},
  ];
        ...
        <div className="relative z-10 mx-auto flex min-h-[90vh] max-w-7xl items-center px-6 py-20 lg:px-14">
          ...
          >
            ...
            <p className="mt-8 max-w-3xl text-lg leading-9 text-slate-200 md:text-xl">
              ...
              trucks, Excavators, Super Link trailers, and 30-tonne heavy-duty
                ...
                Professional Excavator &
                        <span className="block text-orange-400">
                            Earthmoving Services
                                           ...
                                           <p className="mt-8 text-lg leading-9 text-slate-300">
                                              Our modern excavator fleet delivers efficient earthmoving,
                                               mining, site clearing, trenching, and construction support
                                               services for projects of all sizes with experienced operators
                                                               ...
                                                               {[
                                                                ...
                                                                "Site clearing and land preparation",
                                                                 "Professional machine operators",
                                                                           "Reliable heavy equipment solutions",
                                                                           ].map((item, index) => (
          <div
            key={index}
            className="flex items-center gap-4"
